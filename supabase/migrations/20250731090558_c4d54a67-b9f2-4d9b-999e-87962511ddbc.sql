...
-- 1. Enable RLS on advanced_fertilizer_recommendations and add policies
...
-- 2. Create comprehensive RLS policies for crop_cultivation_plans
...
-- 3. Create RLS policies for crop_diseases
...
-- 4. Create RLS policies for crop_growth_tracking
...
-- 5. Create RLS policies for crop_recommendations
...
-- 6. Create RLS policies for fertilizer_recommendations
...
-- 8. Fix database function security - Update the trigger function with proper security
